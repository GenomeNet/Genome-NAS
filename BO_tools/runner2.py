...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 18 17:22:47 2021
...
class Runner(object):
    ...
    def run_super(self):
        ...
        np.save(os.path.join(self.save_dir, genotype_file), genotype)
    
        trainloss_file = 'train_loss-{}'.format(self.save)
        np.save(os.path.join(self.save_dir, trainloss_file), train_losses)
    
        acc_train_file = 'acc_train-{}'.format(self.save)
