...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 27 10:30:50 2021
...
class CNN_Cell_search(nn.Module):
    ...
    def forward(self, s0, s1, weights):
        ...
        for i in range(self._steps):
            ...
            s = sum(cell_ops_new[start+j](h, weights[start+j]) for j, h in enumerate(node_states)) # output dimension bleibt gleich, wenn wir summieren,
            # d.h. states haben immer selbe dimension, egal wie viel wir node_states wir haben
            # start+j
            # 9+0, 9+1, 9+2= 9, 10, 11
